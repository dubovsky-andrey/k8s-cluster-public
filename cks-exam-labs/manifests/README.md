...
lab-09 -> ssh student@<HOST_IP> -p 32009
lab-10 -> ssh student@<HOST_IP> -p 32010
lab-11 -> ssh student@<HOST_IP> -p 32011
...
lab-16 -> ssh student@<HOST_IP> -p 32016
lab-17 -> ssh student@<HOST_IP> -p 32017
```
